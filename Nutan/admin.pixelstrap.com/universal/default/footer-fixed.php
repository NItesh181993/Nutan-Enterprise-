...
<!-- Mirrored from admin.pixelstrap.com/universal/default/footer-fixed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Dec 2019 11:00:16 GMT -->
<head>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active">
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li><a href="footer-fixed.html" class="active"><i class="fa fa-angle-right"></i>Footer Fixed</a></li>
                    </ul>
                </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-xl-6 footer-copyright">
                            <p class="mb-0">2018 © Universal theme by <a href="index-2.html">pixelstrap</a></p>
                        </div>

...
$id =$_GET['id'];
$query1 ="SELECT *FROM sb_details WHERE sbid ='".$id."'";
$query_process = mysqli_query($link,$query1);
                    // echo $query1;
                $result1 = mysqli_fetch_assoc($query_process)
?>
<?php
$query2 ="SELECT *FROM sb WHERE id ='".$id."'";
$query_process = mysqli_query($link,$query2);
                    // echo $query1;
                $result2 = mysqli_fetch_assoc($query_process)
...
<div class="page-wrapper">
  ...
  <li><a href="list_receipe.php">List of switch board</a></li>
  <li>Add receipe</li>
</ul>
        ...
        input[type=text], select, textarea {
          ...
          resize: vertical;
            ...
            <!-- <form action="#.php"> -->
                ...
                <input type="text" id="receipe_name"name="receipe_name" value="<?php echo ($result2['sb_name']) ?>"><br><br>
<style>
 #project
        {
    ...
    .button:hover 
        ...
        color: white;
            ...
            <table>
                <tbody id="project">
                <th width="1%">Sr No.</th>
                <th width="50%"><center>Recipe_name </center></th>
                <th width="7%"><center>Rate </center></th>
                <th width="7%"><center>Quantity</center></th>
                <th width="7%"><center>Total amount</center></th>
                <div class="project1">
                <?php
                include_once('config.php');
                $id=$_GET['id'];
       ...
       <?php   
         ...
         ?>   
                ...
                <td></td>
                            ...
                            <td><input style="width: 100%; background-color:white" disabled="disabled" type="text"value="<?php echo $result2['total'] ?>"></td>                        </tbody>
                     </table>     
</div>
</head>
</html>
            ...
            <ul class="sidebar-menu">
                <li class="active">
                    ...
                    <a href="index.php" class="sidebar-header">
                        <i class="icon-desktop"></i><span>List of project</span>
                    </a>
...
*/*/
            ...
            <div class="col-75">
            <select name="developer"  style="width: 200px;"required="Please Enter Project Name.." >
            ...
            ?>
            <option value="<?php echo $result["developer_name"]; ?>"><?php echo $result['developer_name']?> </option>      
            <?php
            }}?>
            </select>             
            </div>

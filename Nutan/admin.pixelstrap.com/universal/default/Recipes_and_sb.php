            ...
            <ul class="sidebar-menu">
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="index-2.html"><i class="fa fa-angle-right"></i>Default</a></li>
                    ...
                    <ul class="sidebar-submenu">
                        <li class="active">
                            ...
                            <ul class="sidebar-submenu">
                                ...
                                <li><a href="megaoptions.html" class="active"><i class="fa fa-angle-right"></i>Mega Options</a></li>
                            </ul>
                        </li>
                        <li>
                                            ...
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio14" value="option1">
                                            ...
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-secondary mr-3">
                                                        <input type="radio" name="radio1" id="radio13" value="option1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio11" value="option1">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-secondary mr-3">
                                                        <input type="radio" name="radio1" id="radio12" value="option1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio15" value="option1">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio16" value="option1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio17" value="option1">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-secondary mr-3">
                                                        <input type="radio" name="radio1" id="radio18" value="option1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio19" value="option1">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-secondary mr-3">
                                                        <input type="radio" name="radio1" id="radio20" value="option1">
                                            ...
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-info mr-3">
                                                        <input type="radio" name="radio1" id="radio22" value="option1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-primary mr-3">
                                                        <input type="radio" name="radio1" id="radio23" value="option1">
                                                        <label for="radio23"></label>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
                                                        <p>Estimated 10 to 15 Day Shipping ( Duties end tax may be due upon delivery )</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-secondary mr-3">
                                                        <input type="radio" name="radio1" id="radio24" value="option1">
                                                        <label for="radio24"></label>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="mt-0 mega-title-badge">Fast <span class="badge badge-secondary pull-right digits">100 INR</span></h6>
                                                        <p>Estimated 10 to 12 Day Shipping ( Duties end tax may be due upon delivery )</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="media p-20">
                                                    <div class="radio radio-success mr-3">
                                                        <input type="radio" name="radio1" id="radio25" value="option1">
                                                        <label for="radio25"></label>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="mt-0 mega-title-badge">Standard <span class="badge badge-success pull-right digits">80 INR</span></h6>
                                                        <p>Estimated 3 to 5 Day Shipping ( Duties end tax may be due upon delivery )</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-0">
                                                <div class="media p-20">
                                                    <div class="radio radio-warning mr-3">
                                                        <input type="radio" name="radio1" id="radio26" value="option1">
                                            ...
                                            <div class="card mb-0">
                                                <div class="media p-20">
                                                    <div class="radio radio-danger mr-3">
                                                        <input type="radio" name="radio1" id="radio27" value="option1">

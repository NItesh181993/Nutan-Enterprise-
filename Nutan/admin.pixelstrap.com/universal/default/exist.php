...
<div class="page-wrapper">
  ...
  <li><a href="switch_board.php">add switch board</a></li>
  <li>List of existing switch boards</li>
</ul>
        ...
        color: white;
            ...
            <div class ="project">
              ...
              <table id="project">
                ...
                <td>
                    <a href="add_sb_to_project.php?pid=<?php echo $_GET['id'];?>&&id=<?php echo $row['id'];?>"class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add switch board to project" style="padding: 7px;">
                        <i class="fa fa-plus"></i></a>
                               <a href="delete_sb.php?id=<?php echo $row['id'];?>"onclick="return confirm('Are you sure to delete this switch?')"class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete switch board" style="padding: 7px;">
                        <i class="fa fa-trash"></i></a>
                        <a href="show_sb.php?id=<?php echo $row['id']?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View details" <?php $id = $row['id']; ?> style="padding: 7px;" >

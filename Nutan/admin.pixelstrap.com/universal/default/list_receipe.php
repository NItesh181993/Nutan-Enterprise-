...
<div class="page-wrapper">
  ...
  <li><a href="add_item.php">add receipe</a></li>
  <li>List of receipes</li>
</ul>
        ...
        color: white;
            ...
            <div class ="project">
              ...
              <table id="project">
                <tr>
                <th width="6%">Sr No.</th>
                <th width="50%"><center>Receipe List</center></th>
                <th width="10%">cost</th>
                ...
                <tr>    
                <td><?php echo $i++;?></td>
                <td><?php echo $row['receipe_name'];?></td>
                <td> <?php echo $row['grand_total']?></td>
                

                <td>
                    <a href="edit_receipe.php?id=<?php echo $row['id']?>" name="add"<?php {$_SESSION["id"] = $row['id'];} ?> class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add Recipe" style="padding: 7px;">
                        <i class="fa fa-plus"></i></a>
                           <a href="edit_receipe.php?id=<?php echo $row['id'];?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="edit Receipe" style="padding: 7px;">
                           <i class="fa fa-edit"></i></a>   
                        <a href="delete_receipe.php?id=<?php echo $row['id'];?>"onclick="return confirm('Are you sure to delete project?')"class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete project" style="padding: 7px;">
                        <i class="fa fa-trash"></i></a>
                        <a href="show_receipe.php?id=<?php echo $row['id']?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View details" <?php $id = $row['id']; ?> style="padding: 7px;" >
